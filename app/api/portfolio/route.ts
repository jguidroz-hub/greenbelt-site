...
const DEPLOYED_APPS: Record<string, {
  ...
  "QuickFlip": {
    url: "http://quickflip.178.156.240.80.sslip.io",
    status: "live",
    hasStripe: false,
    pfi: null,
    note: "Demo mode live. Restaurant registration added. Migrated to Coolify.",
  },
  "KPI Compass": {
    url: "http://kpi-compass.178.156.240.80.sslip.io",
    status: "live",
    hasStripe: false,
    pfi: 75,
    note: "Auth live. Dashboard hardcoded — KPI CRUD in progress.",
  },
  "StudioOS": {
    url: "http://studioos.178.156.240.80.sslip.io",
    status: "live",
    hasStripe: true,
    pfi: 75,
    note: "5/5 audit: demo login, seeded projects, $79/$149 Stripe plans.",
  },
  "SchemaCraft": {
    url: "http://schemacraft.178.156.240.80.sslip.io",
    status: "live",
    hasStripe: false,
    pfi: 76,
    note: "Core schema gen live (Prisma+SQL). Stripe wired. Auth fixed.",
  },
  "SlackTone AI": {
    url: "http://slacktone-ai.178.156.240.80.sslip.io",
    status: "live",
    hasStripe: false,
    pfi: null,
  ...
  "SkipTheFee": {
    url: "http://skipthefee.178.156.240.80.sslip.io",
    status: "live",
    hasStripe: false,
    pfi: null,
